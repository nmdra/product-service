...
- Verify the JDBC URL in application.properties matches the H2 console settings

### Swagger UI not loading
- Try the alternative URL: http://localhost:8080/swagger-ui/index.html
- Ensure the application started successfully without errors
...
SLIIT - Software Engineering Program
